...
interface OutlineRunner {
    <TRow extends TableRow, TContext, TResult>(name: string, table: readonly TRow[], phases: DocumentedOutline<TContext, TResult, TRow>): void;
    /** @deprecated Add descriptions to given/when/then tuples. */
    <TRow extends TableRow, TContext, TResult>(name: string, table: readonly TRow[], phases: LegacyOutline<TContext, TResult, TRow>): void;
}
